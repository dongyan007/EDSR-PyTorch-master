...
class FeedForward(nn.Module):
    def __init__(self, dim, hidden_dim, dropout = 0.):
        super().__init__()
        self.conv1 = nn.Conv1d(in_channels=dim, out_channels=2048, kernel_size=1)
        self.conv2 = nn.Conv1d(in_channels=2048, out_channels=dim, kernel_size=1)
...
class Decoder(nn.Module):
    def __init__(self):
        ...
        self.transformer = DecoderTransformer(dim, depth, heads, dim_head, mlp_dim, dropout)
